    ...
    fetch("/lattice.json")
      ...
      .then((graph) => {
        ...
        keys.forEach((vtc, idx) => {
          ...
          homePositions[vtc] = new THREE.Vector3(ox, oy, oz);
          velocities[vtc] = new THREE.Vector3(0, 0, 0);
          shardData[vtc] = {
            vtc,
            type: node.type,
            count: node.count,
          ...
          mesh.scale.setScalar((scale * crystalSize * 1.5) * 0.225);
          ...
          // wireframe disabled for clarity
